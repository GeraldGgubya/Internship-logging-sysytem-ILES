...
// Uses environment variable — no hardcoded localhost
        ...
        <div className="login-wrap">
            <div className="login-card">
                ...
                <div className="field">
                    ...
                    <input type="email" placeholder="you@university.ac.ug" value={email}
                ...
                <p style={{ marginTop:20, fontSize:12, color:"var(--muted)", textAlign:"center", lineHeight:1.6 }}>
                    Internship Logging &amp; Evaluation System<br/>Makerere University
                </p>
            </div>
        </div>
    );
