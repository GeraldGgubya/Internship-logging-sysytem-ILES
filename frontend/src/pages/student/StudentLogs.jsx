                ...
                {loading ? (
                    ...
                    <div className="table-wrap">
                        <table>
                            <thead>
                                <tr>
                                    <th>Week</th><th>Date Submitted</th>
                            ...
                            <tbody>
                                {logs.map(log => (
                                    <tr key={log.id}>
                                        ...
                                        <td className="text-muted text-sm">{log.log_content?.slice(0, 60)}…</td>
                                        <td>
                ...
                <div className="modal-backdrop" onClick={() => setViewLog(null)}>
                    <div className="modal" style={{ maxWidth:620 }} onClick={e => e.stopPropagation()}>
                        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:16 }}>
                            <div className="modal-title" style={{ margin:0 }}>Week {viewLog.week_number} Log</div>
